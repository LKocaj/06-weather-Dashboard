...
// City search event listener jquery
$("#citySearchBtn").on("click", function(event){
    event.preventDefault();

    cityname = $("#cityInput").val().trim();
    if(cityname === ""){
        alert("Enter city to lookup")
...
// API call and display city, weather, and 5 day forecast to DOM
async function displayWeather() {

    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=7c101ea762b1356033321af8bd8d0ad9";
    ...
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=7c101ea762b1356033321af8bd8d0ad9&lat="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=7c101ea762b1356033321af8bd8d0ad9";
